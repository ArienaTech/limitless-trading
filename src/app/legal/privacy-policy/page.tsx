    ...
    <div className="bg-void text-text min-h-screen">
      ...
      <main className="gutter pt-36 pb-32 max-w-3xl">
        ...
        <div className="flex flex-col gap-12 text-text-soft text-[14px] leading-relaxed">
          ...
          <section>
            <h2 className="display font-bold text-text text-[18px] mb-4">2. What data we collect</h2>
          ...
          <section>
            <h2 className="display font-bold text-text text-[18px] mb-4">6. Your rights</h2>
          ...
          <section>
            <h2 className="display font-bold text-text text-[18px] mb-4">7. Cookies</h2>
          ...
          <section>
            <h2 className="display font-bold text-text text-[18px] mb-4">8. Contact</h2>
